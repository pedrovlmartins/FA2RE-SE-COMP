 ...
 * </dl>
 *
 * @version v0.6.1, 2016/04/10 (April) -- Patch of Markus Keunecke is added. The
 *          eclipse project configuration was extended with the maven nature.
...
public class GraphViz {
	...
	/**
	 * Convenience Constructor with default OS specific pathes creates a new
	 * GraphViz object that will contain a graph. Windows: executable =
	 * c:/Program Files (x86)/Graphviz 2.28/bin/dot.exe tempDir = c:/temp MacOs:
	 * executable = /usr/local/bin/dot tempDir = /tmp Linux: executable =
	 * /usr/bin/dot tempDir = /tmp
	 */
	public GraphViz() {
		if (GraphViz.osName.equals("Windows")) {
			this.tempDir = "C:/Users/Pedro";
	 ...
	 * @throws IOException 
	 */
	public void readSource(String input) throws IOException {
